...
<div id="container">
    ...
    <div id="story">
        ...
        <?php
            if($type == "featured")
                $selectstory = mysql_query("SELECT * FROM stories WHERE featured=1 ORDER BY id DESC");
            else if($type == "newest")
                $selectstory = mysql_query("SELECT * FROM stories ORDER BY id DESC");
            else if($type == "oldest")
                $selectstory = mysql_query("SELECT * FROM stories ORDER BY id");
            ...
            {
                echo "<br><h1 class='notfound'>No Stories Found</h1>";
            }
        ?>
