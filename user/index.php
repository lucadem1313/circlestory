...
$selectid = mysql_query("SELECT * FROM users WHERE username='$selecteduser'");
...
<div id="container">
        ...
        <?php
            ...
            $selectuser = mysql_query("SELECT * FROM users WHERE id='".$selecteduserid."'");
        
            while($row = mysql_fetch_array($selectuser))
            {
            ...
            echo "<br><br><br><br><br><br><h1 class='sectionheading'>Stories:</h1><br>";
            $selectstory = mysql_query("SELECT * FROM stories WHERE userid=".$selecteduserid." ORDER BY id DESC");
