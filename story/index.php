...
<head>
    ...
    <script>
        $(document).ready(function(){
            ...
            $(document).on("click", ".prewritten img[src='<?php echo $relative."images/feature.png"; ?>']", function(){
                var image = $(this);
                $.ajax({
                    type: "POST",
                    url: "process.php",
                    data: {feature: true, id: $(this).parents(".story").data('storyid')},
                    success: function(response){
                        //console.log(response);
                        image.attr("src", "<?php echo $relative."images/featured.png"; ?>");
                    }
                });
            });
            $(document).on("click", ".prewritten img[src='<?php echo $relative."images/featured.png"; ?>']", function(){
                var image = $(this);
                $.ajax({
                    type: "POST",
                    url: "process.php",
                    data: {unfeature: true, id: $(this).parents(".story").data('storyid')},
                    success: function(response){
                        //console.log(response);
                        image.attr("src", "<?php echo $relative."images/feature.png"; ?>");
                    }
                });
            });
            ...
            $(document).on("click", ".prewritten img[src='<?php echo $relative."images/delete.png"; ?>']", function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "process.php",
                    data: {deletestory: true, id: image.parents(".story").data('storyid')},
                    success: function(response){
                        window.open('<?php echo $relative; ?>', '_self');
                    }
                });
            });
            $(document).on("click", ".continued img[src='<?php echo $relative."images/delete.png"; ?>']", function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "process.php",
                    data: {deleteaddition: true, additionid: image.parents(".story").data('additionid'), storyid: <?php echo $storyid; ?>},
                    success: function(response){
                        window.location.reload();
                    }
                });
            ...
            while($row = mysql_fetch_array($selectstory))
            {
                ...
                if($loggedin)
                {
                    ...
                    if($mod){
                        ...
                        echo '<img src="'.$relative.'images/delete.png" alt="delete">';
                        if($row{'verified'} == 1){
                        ...
                        if($row{'featured'} == 1){
                            echo "<img src='".$relative."images/featured.png' alt='featured story' >";
                        } else {
                            echo "<img src='".$relative."images/feature.png' alt='feature story'>";
                        }
                    }
                }
                echo '</span></p>';
